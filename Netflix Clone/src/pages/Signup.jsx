...
const Signup = () =>{
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();//her seferinde sayfa yenilenmesini önler//
    setError('')
    try {
            ...
            <div className='max-w-[320px] mx-auto py-16'>
              ...
              <form onSubmit={handleSubmit} className='py-5 w-full flex-col flex'> 
                ...
                <button className='bg-red-700 rounded text-font-sans py-2 px-2 '>
                  ...
                  <div>
                    <p className='text-gray-600'>Already subscribed?</p>
                    <p className='text-gray-300'><Link to='/login'>Sign In</Link> </p>
                  </div>
